...
class RepliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reply" do
    assert_difference('Reply.count') do
      post replies_url, params: { reply: { child_id: @reply.child_id, parent_id: @reply.parent_id } }
    end
  ...
  test "should update reply" do
    patch reply_url(@reply), params: { reply: { child_id: @reply.child_id, parent_id: @reply.parent_id } }
